...
This plugin automatically sets the `subpackages` option to `false` when loaded. This means that pkgbld will not create subpackage directories with `package.json` files for non-index entry points.
